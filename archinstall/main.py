...
def _fetch_arch_db() -> bool:
	...
	try:
		...
		error('Run 1 --debug and check /var/log/1/install.log for details.')
...
def run() -> int:
	...
	OR straight as a module: python -m 1
...
def _error_message(exc: Exception) -> None:
	...
	text = textwrap.dedent(
		...
		https://github.com/archlinux/archinstall and include the log file "/var/log/1/install.log".

		Hint: To extract the log from a live ISO
		curl -F 'file=@/var/log/1/install.log' https://0x0.st
		"""
	)
	warn(text)
